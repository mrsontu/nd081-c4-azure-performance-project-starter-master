...
logger.addHandler(AzureLogHandler(connection_string=f'{INSTRUMENTATION_KEY}'))
logger.setLevel(logging.INFO)

# Metrics
exporter = MetricsExporter(connection_string=f'{INSTRUMENTATION_KEY}')

# Tracing
tracer = AzureExporter(connection_string=f'{INSTRUMENTATION_KEY}')
